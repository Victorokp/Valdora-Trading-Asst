...
- **Immutable, hash-gated against the original Phase-29 experiment
  ...
  byte-identical duplicates of their root counterparts — pinned
  explicitly so no committed experimental artifact escapes the gate.
  `PHASE29_DATA_AUDIT.md`, `PHASE29_DECISION.md`, and
