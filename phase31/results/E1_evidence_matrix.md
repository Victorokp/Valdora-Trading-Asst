...
| 7 | Drawdown/recovery structure (C3) | 10 episodes; depths −12, −9, −4, −3×4, −2, −1×2; 89/115 trades underwater; longest recovery 34 trades; −12R episode: 29 trades down, 7 to recover | **SUPPORTED** (path characterized) | The realized path's drawdown structure is fully characterized and consistent with Phase-29's episode analysis | Path characteristics of one realization do not bound future paths (see B2/Monte-Carlo envelope) |
